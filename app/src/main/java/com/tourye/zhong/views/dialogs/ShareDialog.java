...
public class ShareDialog extends Dialog implements View.OnClickListener {
    ...
    private String mTitle = "陶冶户外";
    private String mDesc = "一生必走的九大路线";
     ...
     * 设置数据
     */
    public void setParameter(String mTitle,String desc,String imgUrl,String linkUrl) {
        this.mTitle = mTitle;
        this.mDesc=desc;
        this.mImgUrl=imgUrl;
        this.mLink=linkUrl;
...
//        oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        ...
        //分享成功失败的回调
        final String finalPlat_form = platform;
